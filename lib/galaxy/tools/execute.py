...
class ExecutionTracker:
    ...
    @property
    def validated_param_combinations(self) -> list[Optional[JobInternalToolState]]:
    ...
    def new_execution_slices(self):
        if self.collection_info is None:
            for job_index, (param_combination, validated_param_combination) in enumerate(zip(self.param_combinations, self.validated_param_combinations)):
...
class ToolExecutionTracker(ExecutionTracker):
    ...
    def new_collection_execution_slices(self):
        for job_index, (param_combination, validated_param_combination, (dataset_collection_elements, _when_value)) in enumerate(
