...
class WorkflowModule:
    ...
    def execute(self, trans, progress: "WorkflowProgress", invocation_step, use_cached_job=False):
    ...
    def _find_collections_to_match(self, progress: "WorkflowProgress", step, all_inputs):
